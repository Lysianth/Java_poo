...
public class Application {
	...
	public static void main(String[] args) {
		...
		Car car4 = new Car ("Mercedes",13000,2011,"Gugvuv67");
		
		Car.Hello();
		System.out.println(car1.getBrand() + " " + car1.getInitialPrice() +" " + car1.getManufacturingYear() +" "+ car1.getRegistrationNumber() );
